...
const PropertiesWantedLease = ({ selectedPropertyTypes }) => {
    ...
    return (
        <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 relative">
                    <div className="relative">
                        <PriceRangeSlider label={"Leasing Rate"} minimumPrice={50000} maximumPrice={80000} handleSliderChange={handleSliderChange} priceRange={formData.leasingRate} />
                    </div>
                </div>
...
export default PropertiesWantedLease;
